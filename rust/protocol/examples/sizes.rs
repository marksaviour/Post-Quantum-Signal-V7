...
/// The KEM under measurement. This line builds ML-KEM-1024 and nothing else, so the constant is
/// pinned. The Version 2 copy of this file selects between HQC-256 and ML-KEM-1024 with a
/// `cfg(feature = "hqc256")` gate, which is the only difference between the two copies: `hqc256`
/// is not a feature this manifest declares, so naming it here would warn under `unexpected_cfgs`.
